...
🔗 [Explora el proyecto aquí](https://github.com/Cristina-Puertas-Camarero/Trigger_Key_Words) 

### **A/B Testing**  
**Visualización de datos en comparacion de app en VANGUARD.**  
Herramientas utilizadas: **Tableau**, **SQL**, **Power BI**, y herramientas para análisis exploratorio.  
🔗 [Conoce más aquí](https://github.com/Cristina-Puertas-Camarero/A-B-Testing-Vanguard)
...
- Desarrollo de **dashboards interactivos**  en **Power BI** y **Tableau**.
...
###  **Datos raros**  
Me encanta desenrollar cables y Star Wars 💪😉
