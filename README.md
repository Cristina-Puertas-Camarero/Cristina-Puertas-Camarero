...
Identifico qué consume tiempo innecesariamente y lo elimino. Python, scripts, APIs, integraciones entre sistemas — lo que haga falta para que el equipo deje de hacer trabajo que no aporta.

**🌐 Desarrollo de aplicaciones web**
Herramientas internas a medida: dashboards interactivos, apps de gestión, interfaces sobre datos. Rápido, funcional, pensado para quien lo va a usar.

</td>
<td width="50%" valign="top">

**🖥️ Gestión de IT**
Estrategia tecnológica, soporte, herramientas corporativas, coordinación con proveedores. La parte que conecta la tecnología con las personas que la usan.

**🤖 Inteligencia Artificial aplicada**
Integración de modelos de lenguaje propios en procesos de negocio. NLP, clasificación de texto, automatización de tareas cognitivas con IA propia — no solo herramientas externas.
...
<img src="https://skillicons.dev/icons?i=python,js,html,css,fastapi,git,github,azure,vscode,jupyter&perline=10&theme=dark"/>
